...
void LanguageLayout::CPrivate::InitChinese()
{
    ...
    for (KeyBoardButton *btn : mKeyList)
    {
        connect(btn, &KeyBoardButton::SignalKeyReleased, mParent, &LanguageLayout::SlotKeyClicked);
    }
    ...
    for (KeyBoardButton *btn : mKeyList)
    {
        ...
        else
        {
            ...
            connect(btn, &KeyBoardButton::SignalKeyReleased, mParent, &LanguageLayout::SlotKeyClicked); // 按键释放
        }
    }
}
